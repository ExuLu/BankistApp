...
const account1 = {
  ...
  movementsDates: [
    ...
    '2023-03-22T17:01:17.194Z',
    '2023-03-26T23:36:17.929Z',
...
const formatMovementDay = function (date, locale) {
  const calcDaysPassed = (date1, date2) =>
    Math.round(Math.abs(date2 - date1) / 86_400_000);

  const datePassed = calcDaysPassed(new Date(), date);
